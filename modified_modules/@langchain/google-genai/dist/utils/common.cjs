...
exports.convertToGenerativeAITools =
  exports.convertResponseContentToChatGenerationChunk =
  exports.mapGenerateContentResultToChatResult =
  exports.convertBaseMessagesToContent =
  exports.convertMessageContentToParts =
  exports.convertAuthorToRole =
  ...
  return [
    {
      functionDeclarations: structuredTools.map((structuredTool) => {
        if ((0, function_calling_1.isStructuredTool)(structuredTool)) {
          const jsonSchema = (0,
          zod_to_genai_parameters_js_1.zodToGenerativeAIParameters)(
        ...
        if ((0, base_1.isOpenAITool)(structuredTool)) {
          return {
            ...
            parameters: (0,
            zod_to_genai_parameters_js_1.jsonSchemaToGeminiParameters)(
